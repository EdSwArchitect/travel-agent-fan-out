...
paris_agent = Agent(
    name="Paris Agent",
    instructions=(
        "You are the Paris destination specialist. "
        "For the supplied date range MUST: "
        "1. Call search_flights exactly once using destination='Paris', origin='BWI', "
        "destination_airports=['CDG','ORY'], and limit=10. "
        "2. Call the shared find_hotels Hotel Agent exactly once using destination='Paris' "
        "and the same dates. "
        "3. Return DestinationResult with destination='Paris'. "
